...
class Dashboard_model extends TI_Model {
	...
	public function getStatistics($stat_range = '', $restaurant_id = FALSE) {
		...
		$results['sales'] = $this->getTotalSales($range_query, $restaurant_id);
		$results['lost_sales'] = $this->getTotalLostSales($range_query, $restaurant_id);
		$results['customers'] = $this->getTotalCustomers($range_query);
		$results['orders'] = $this->getTotalOrders($range_query, $restaurant_id);
		$results['orders_completed'] = $this->getTotalOrdersCompleted($range_query, $restaurant_id);
		$results['delivery_orders'] = $this->getTotalDeliveryOrders($range_query, $restaurant_id);
		$results['collection_orders'] = $this->getTotalCollectionOrders($range_query, $restaurant_id);
		$results['tables_reserved'] = $this->getTotalTablesReserved($range_query);
		$results['cash_payments'] = $this->getTotalCashPayments($range_query, $restaurant_id);
	...
	public function getTotalSales($range_query, $restaurant_id = FALSE) {
		$total_sales = 0;
	...
	public function getTotalLostSales($range_query, $restaurant_id=FALSE) {
		$total_lost_sales = 0;
	...
	public function getTotalCashPayments($range_query = '', $restaurant_id=FALSE) {
		$cash_payments = 0;
	...
	public function getTotalOrders($range_query, $restaurant_id=FALSE) {
		$total_orders = 0;
	...
	public function getTotalOrdersCompleted($range_query = '', $restaurant_id=FALSE) {
	...
	public function getTotalDeliveryOrders($range_query = '', $restaurant_id=FALSE) {
	...
	public function getTotalCollectionOrders($range_query = '', $restaurant_id=FALSE) {
	...
	public function getTodayChart($hour = FALSE, $restaurant_id=FALSE) {
		$result = array();
	...
	public function getDateChart($date = FALSE, $restaurant_id=FALSE) {
		$result = array();
	...
	public function getTopCustomers($filter = array()) {
		...
		if ($this->db->limit($filter['limit'], $filter['page'])) {
			...
			if (!empty($filter['restaurant_id'])) {		     
               $this->db->where('orders.restaurant_id', $filter['restaurant_id']);
	    	}
