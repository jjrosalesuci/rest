...
class Locations_model extends TI_Model {
	...
	public function getLocationIdByIdRestaurant($restaurant_id){		
	...
	public function getLocations($restaurant_id = FALSE) {
		$this->db->from('locations');
	...
	public function getLocation($location_id, $restaurant_id = FALSE) {
	...
	// Multi restaurant suport
	public function saveLocation($location_id, $save = array(), $restaurant_id) {
