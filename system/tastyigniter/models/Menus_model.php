...
class Menus_model extends TI_Model {
	...
	public function getCount($filter = array()) {
		...
		if ( ! empty($filter['restaurant_id'])) {
			$this->db->where($this->db->dbprefix('menus').'.restaurant_id', $filter['restaurant_id']);
		}
	...
	public function getMenu($menu_id,$restaurant_id) {
		...
		if (!empty($restaurant_id)) {
		  $this->db->where($this->db->dbprefix('menus').'.restaurant_id', $restaurant_id);
		}
	...
	public function saveMenu($menu_id, $save = array(),	$restaurant_id) {
