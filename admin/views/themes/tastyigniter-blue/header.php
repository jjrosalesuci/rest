<?php
	...
	$restaurant_name    = $this->user->getCurrentRestaurantName();
						...
						<a class="dropdown-toggle settings" data-toggle="dropdown">
								 ...
								 <?php if(count($restaurant_list)>1) { ?>
									<label style="text-decoration: underline;"> 
										<?php echo lang('change_restaurant');?>
									</label> 
								 <?php } ?>
							</i>
						</a>
						<?php if(count($restaurant_list)>1) { ?>
							<ul class="dropdown-menu dropdown-settings">						   
								<?php foreach($restaurant_list as $restaurant){ ?>								   
									<li> <a href="<?php echo site_url('dashboard'); ?>/changerestaurant?restaurant_id=<?php echo $restaurant['restaurant_id'];?>&restaurant_name= <?php echo $restaurant['name']; ?> "  ><?php echo $restaurant['name']; ?></a></li>
								<?php } ?>							
							</ul>
					    <?php } ?>
					</li>
