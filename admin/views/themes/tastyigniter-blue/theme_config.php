...
$theme['nav_menu'] = array(
	...
	'sales' => array(
		'class' => 'sales',
		'icon' => 'fa-bar-chart-o',
		'title' => lang('menu_sale') .' <span id="badge_recived_orders" class="badge badge-recived-orders">2</span> ',
		'permission' => 'Admin.Orders|Admin.Reservations|Admin.Coupons',
		'child' => array(
			'monitor' => array('class' => 'monitor', 'href' => site_url('monitor'), 'title' => lang('menu_monitor'), 'permission' => 'Admin.Orders'),
