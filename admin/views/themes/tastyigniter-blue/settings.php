	...
	<div class="col-md-12">
		<div class="row wrap-vertical">
			<ul id="nav-tabs" class="nav nav-tabs">
				...
				<li><a href="#fees" data-toggle="tab"><?php echo lang('text_tab_fees'); ?></a></li>
			</ul>
		</div>
		...
		<form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo current_url(); ?>" enctype="multipart/form-data" />
			<div class="tab-content">
				...
				<div id="fees" class="tab-pane row wrap-all active">
					<h4 class="tab-pane-title"><?php echo lang('text_tab_title_user_fee'); ?></h4>
					<div class="form-group">
						<label for="input-site-name" class="col-sm-3 control-label"><?php echo lang('label_fee_percentaje'); ?>(%)</label>
						<div class="col-sm-5">
							<input type="text" name="user_fee_percentaje" id="input-user_fee_percentaje" class="form-control" value="<?php echo config_item('user_fee_percentaje'); ?>" />
							<?php echo form_error('user_fee_percentaje', '<span class="text-danger">', '</span>'); ?>
						</div>
					</div>
					<div class="form-group">
						<label for="input-site-email" class="col-sm-3 control-label"><?php echo lang('label_fee_amount'); ?> ($) </label>
						<div class="col-sm-5">
							<input type="text" name="user_fee_amount" id="input-user_fee_amount" class="form-control" value="<?php echo config_item('user_fee_amount'); ?>" autocomplete="off" />
							<?php echo form_error('user_fee_amount', '<span class="text-danger">', '</span>'); ?>
						</div>
					</div>

					<h4 class="tab-pane-title"><?php echo lang('text_tab_title_restaurant_fee'); ?></h4>
					<div class="form-group">
						<label for="input-site-name" class="col-sm-3 control-label"><?php echo lang('label_fee_percentaje'); ?> (%)</label>
						<div class="col-sm-5">
							<input type="text" name="restaurant_fee_percentaje" id="input-restaurant_fee_percentaje" class="form-control" value="<?php echo config_item('restaurant_fee_percentaje'); ?>" />
							<?php echo form_error('restaurant_fee_percentaje', '<span class="text-danger">', '</span>'); ?>
						</div>
					</div>
					<div class="form-group">
						<label for="input-site-email" class="col-sm-3 control-label"><?php echo lang('label_fee_amount'); ?> ($) </label>
						<div class="col-sm-5">
							<input type="text" name="restaurant_fee_amount" id="input-restaurant_fee_amount" class="form-control" value="<?php echo config_item('restaurant_fee_amount'); ?>" autocomplete="off" />
							<?php echo form_error('restaurant_fee_amount', '<span class="text-danger">', '</span>'); ?>
						</div>
					</div>
				</div>
			</div>
