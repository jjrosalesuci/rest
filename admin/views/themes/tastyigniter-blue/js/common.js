...
$(document).ready(function() {
    ...
    var n = str.search("monitor");
    if(n==-1){
        SearchForNewOrders(base_url);
        setInterval(function(){
             $.ajax({
                type: "POST",
                    url  : base_url +"monitor/RecivedOrdersCuantity", 
                    data : {},
                    dataType: "json",
                    success: function(data){
                    if(data.recived>=1){
                            $("#badge_recived_orders").show();
                            $("#badge_recived_orders").text(data.recived);  
                    }else{
                            $("#badge_recived_orders").hide();
                        }
                    }
                });
        },10000);
...
function SearchForNewOrders(base_url){
      $.ajax({
                type: "POST",
                url:  base_url +"monitor/RecivedOrdersCuantity", 
                data: {},
