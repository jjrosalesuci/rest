...
class Tables extends Admin_Controller {
	...
	public function edit() {
		$table_info = $this->Tables_model->getTable((int) $this->input->get('id'), $this->user->restaurant_id);
	...
	private function _saveTable() {
    	if ($this->validateForm() === TRUE) {
			...
			if ($table_id = $this->Tables_model->saveTable($this->input->get('id'), $this->input->post(), $this->user->restaurant_id )) {
