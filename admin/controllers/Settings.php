...
class Settings extends Admin_Controller {
	...
	private function _updateSettings() {
        if ($this->validateForm() === TRUE) {
	        $update = array(
				...
				'user_fee_percentaje'              => $this->input->post('user_fee_percentaje'),
		        'user_fee_amount'                  => $this->input->post('user_fee_amount'),
		        'restaurant_fee_percentaje'        => $this->input->post('restaurant_fee_percentaje'),
		        'restaurant_fee_amount'            => $this->input->post('restaurant_fee_amount'),
	        );
	...
	private function validateForm() {
		...
		$this->form_validation->set_rules('default_location_id', 'lang:label_default_location', 'xss_clean|trim|integer');
		...
		$this->form_validation->set_rules('user_fee_percentaje'		  , 'lang:label_user_fee_percentaje', 'xss_clean|trim|required|numeric');
		$this->form_validation->set_rules('user_fee_amount'			  , 'lang:label_user_fee_amount', 'xss_clean|trim|required|numeric');
		$this->form_validation->set_rules('restaurant_fee_percentaje' , 'lang:label_restaurant_fee_percentaje', 'xss_clean|trim|required|numeric');
		$this->form_validation->set_rules('restaurant_fee_amount'     , 'lang:label_restaurant_fee_amount', 'xss_clean|trim|required|numeric');
