...
class Menu_options extends Admin_Controller {
	...
	public function edit() {
		...
		$option_info = $this->Menu_options_model->getOption((int) $this->input->get('id'),$this->user->restaurant_id);
	...
	private function _saveOption() {
    	if ($this->validateForm() === TRUE) {
			...
			if ($option_id = $this->Menu_options_model->saveOption($this->input->get('id'), $this->input->post(),$this->user->restaurant_id)) {
