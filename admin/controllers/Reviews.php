...
class Reviews extends Admin_Controller {
	...
	public function index() {
		...
		$review_dates = $this->Reviews_model->getReviewDates($this->user->restaurant_id);
	...
	public function edit() {
		$review_info = $this->Reviews_model->getReview((int) $this->input->get('id'),$this->user->restaurant_id );
	...
	private function _saveReview() {
    	if ($this->validateForm() === TRUE) {
			...
			if ($review_id = $this->Reviews_model->saveReview($this->input->get('id'), $this->input->post(),$this->user->restaurant_id)) {
