...
class Coupons extends Admin_Controller {
	...
	public function edit() {
		...
		$coupon_info = $this->Coupons_model->getCoupon((int) $this->input->get('id'), $this->user->restaurant_id);
    ...
    private function _saveCoupon() {
    	if ($this->validateForm() === TRUE) {
			...
			if ($coupon_id = $this->Coupons_model->saveCoupon($this->input->get('id'), $this->input->post(),$this->user->restaurant_id)) {
