...
class Menus extends Admin_Controller {
	...
	public function edit() {
		...
		$menu_info = $this->Menus_model->getMenu((int) $this->input->get('id'),$this->user->restaurant_id);
		...
		$results = $this->Mealtimes_model->getMealtimes($this->user->restaurant_id);
		foreach ($results as $result) {
		...
		if ($this->input->post('menu_options')) {
			...
			$menu_options = $this->Menu_options_model->getMenuOptions($menu_id,$this->user->restaurant_id);
		}
	...
	private function _saveMenu() {
		if ($this->validateForm() === TRUE) {
			...
			if ($menu_id = $this->Menus_model->saveMenu($this->input->get('id'), $this->input->post(),$this->user->restaurant_id)) {
