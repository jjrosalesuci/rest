...
class Local extends Main_Controller {
	...
	public function index() {
		...
		$filter['restaurant_id'] = $location['restaurant_id'];
...
//				$review_totals = isset($review_totals[$location['location_id']]) ? $review_totals[$location['location_id']] : 0;
				...
				$data['locations'][] = array(                                                            // create array of menu data to be sent to view
					...
					'total_reviews'     => $review_totals[$location['location_id']] ? $review_totals[$location['location_id']] : 0,
					...
					'distance'   		=> $lat && $lng ? round($this->location->checkDistance($lat,$lng)) : round($this->location->checkDistance()) ,
